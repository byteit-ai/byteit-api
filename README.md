...
- `create_job(input_connector, output_connector=None, processing_options=None, timeout=30)` - Create a new processing job
...
- `process_document(input_connector, output_connector=None, processing_options=None, output_path=None, poll_interval=5, max_wait_time=600, timeout=30)` - Convenience method for end-to-end processing
