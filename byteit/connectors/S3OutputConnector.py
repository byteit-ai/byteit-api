...
class S3OutputConnector(OutputConnector):
    ...
    directly to your S3 bucket. The result does NOT pass through your local
    machine.
    ...
    Note:
        The ByteIT server will use the IAM role configured in your AWS
        connection to write to the S3 bucket. No AWS credentials are needed in
        your client code.
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Returns:
            Dictionary with connector type and configuration matching API
            format: {"type": "s3", "bucket": "bucket-name", "path":
            "output/path/"}
        """
        return {
            "type": "s3",
